          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Компания "АвтоЗапчасти" работает на рынке автомобильных запчастей с 2010 года. За это время мы зарекомендовали себя как надежный партнер для тысяч автовладельцев и сервисных центров.
                </p>
                <p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+74951234567" className="text-blue-600 hover:text-blue-700">
                      +7 (495) 123-45-67
                    </a>
                    <p className="text-sm text-gray-600 mt-1">Бесплатный звонок по России</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@avtozapchasti.ru" className="text-blue-600 hover:text-blue-700">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">м. Примерная, 5 минут пешком</p>
                  </div>
                </div>
