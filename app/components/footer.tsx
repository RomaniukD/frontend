        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="font-bold text-xl text-white">АвтоЗапчасти</div>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Качественные автозапчасти для вашего автомобиля. Широкий ассортимент, доступные цены, быстрая доставка.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <div className="text-sm">+7 (495) 123-45-67</div>
                  <div className="text-xs text-gray-400">Бесплатный звонок</div>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <Mail className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                <div className="text-sm">info@avtozapchasti.ru</div>
              </li>
              <li className="flex items-start gap-2">
